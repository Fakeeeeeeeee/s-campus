...
<div id="cont">
 ...
 <div id="contenido" align="center">
  <h2>&nbsp;</h2>
  <center><h2>Modificar foto de Perf&iacute;l</h2></center>
  
  <?php
					include("conexion.php");
					$id = $_REQUEST['id'];
					$query = "SELECT id,imagen from fotoperfil where id='$id'"; 
 ...
 <center>
    ...
    <a href="datos.php"><input type="submit" value="volver" /></a>
    </center>
