...
<div id="cont">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="docentes_u.php">Docentes</a></li> 
      </ul>
 ...
 <p>&nbsp;</p>
 <h4><span class="glyphicon glyphicon-list-alt"></span> Docente</h4><div><form class="navbar-form navbar-left">
        <div class="form-group">
          Nombre <input type="text" class="form-control" placeholder="Search">
        </div>
