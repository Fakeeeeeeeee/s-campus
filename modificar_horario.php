...
<div id="cont">
 ...
 <form action="horario_s.php?a=m" method="post">
 ...
 <table style="border:1px #333 solid;" class="table table-striped table table-hover">
	...
	$sql = $conn->query("SELECT sala_bloque.fecha,bloque.idbloque,bloque.hora_inicio,bloque.hora_fin,profesor.nombre,sala_bloque.sala_idsala FROM clase,sala_bloque,bloque,profesor,asignatura,seccion where sala_bloque.idsala_bloque=clase.sala_bloque_idsala_bloque and sala_bloque.bloque_idbloque=bloque.idbloque and clase.profesor_idprofesor=profesor.idprofesor and clase.asignatura_idasignatura=asignatura.idasignatura and clase.seccion_idseccion=seccion.idseccion and clase.idclase=".$id);
	$getr = $sql->fetch_array();
	
	echo '
	<tr>
		<td style="font-size:12px;font-weight:bold;">Sala:</td>
		<td style="font-size:12px;">'.$getr[5].'</td>
	</tr>	
	<tr>
	...
	<tr>	
		...
		<td style="font-size:12px;">'.$getr[1].'</td>
	</tr>	
	<tr>	
		<td style="font-size:12px;font-weight:bold;">Bloque:</td>
		<td style="font-size:12px;">'.$getr[2].' - '.$getr[3].'</td>
	</tr>	
	<tr>
		<td style="font-size:12px;font-weight:bold;">Profesor:</td>
		<td style="font-size:12px;">'.$getr[4].'</td>
	</tr>
	';
